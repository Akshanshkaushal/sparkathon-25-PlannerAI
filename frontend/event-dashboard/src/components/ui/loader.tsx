...
export const LoaderFive = ({ text = "Analysing inputs and using latest insights using advanced AI model" }: { text?: string }) => {
  return (
...
export const LoaderFour = ({ text = "Analysing inputs and using latest insights using advanced AI model" }: { text?: string }) => {
  return (
    <div className="relative font-bold text-black [perspective:1000px] dark:text-white">
      <motion.span
        animate={{
